...
var buildFullPath = __webpack_require__(60);
...
var _qs = __webpack_require__(224);
...
exports.default = {
  ...
  methods: {
    ...
    uploadFileChunks: function uploadFileChunks() {
      var _this = this;

      if (this.file == null) return;
      var fileChunkList = this.createChunks();
      var uploadProcess = fileChunkList.map(function (item, index) {
      ...
      _promise2.default.all(uploadProcess).then(function (res) {
        console.log('分片上传成功');
      }).catch(function (err) {
...
// module
exports.push([module.i, ".upload-container[data-v-5ae9e133]{font-size:12px;padding:10px}.upload-container .upload-btn[data-v-5ae9e133]{width:auto;padding:2px 6px}", ""]);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("直接上传")]), _vm._v(" "), _c('button', {
    staticClass: "upload-btn",
    on: {
      "click": _vm.uploadFileChunks
    }
  }, [_vm._v("分片上传")])])
},staticRenderFns: []}
...
var update = __webpack_require__(20)("06260adb", content, true);
